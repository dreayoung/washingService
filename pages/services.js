  ...
  return (
    <>
      <main className="flex min-h-screen flex-col items-center pt-10 text-zinc-50 text-center">
        ...
        <div className="flex lg:flex-row flex-col justify-center items-start lg:space-x-6 space-y-6 lg:space-y-0 lg:pt-20 pt-8 text-center lg:px-10 px-20">
          <div>
      ...
      <hr className="border-zinc-500 w-[95%] m-auto" />
      <Footer />
    </>
  );
}
